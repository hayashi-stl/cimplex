...
mod internal {
    ...
    use crate::tri::internal::{RemoveTriHigher, ClearTrisHigher};
    ...
    crate::impl_edge!(HigherEdge<E>, new |id, link, value| {
        HigherEdge { 
            tri_opp: id,
            link,
            value
